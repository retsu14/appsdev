...
function TableFeedback({ title, title2, feedbacks }) {
  ...
  const totalRows = feedbacks.length;
  ...
  const filteredFeedbacks = feedbacks.filter((feedback) => {
    const number = feedback.name;
    const headName = feedback.email;
  ...
  const visibleFeedbacks = filteredFeedbacks.slice(startIndex, endIndex);
