...
import { updateBarangayOfficial } from "../features/barangayOfficials/barangaySlice";
import { useDispatch } from "react-redux";

function ModalUpdate({ name, positions, barangayofficials }) {
  const dispatch = useDispatch();

  //   const { isLoading } = useSelector((state) => state.barangayofficials);
  ...
  useEffect(() => {
    if (barangayofficials) {
      setFormData({
        fname: barangayofficials.fname,
        lname: barangayofficials.lname,
        isActive: barangayofficials.isActive,
        term: barangayofficials.term,
        position: barangayofficials.position,
        age: barangayofficials.age,
        gender: barangayofficials.gender,
        birthday: barangayofficials.birthday,
        phonenumber: barangayofficials.phonenumber,
        birthplace: barangayofficials.birthplace,
        email: barangayofficials.email,
        purok: barangayofficials.purok,
      });
    }
  }, [barangayofficials]);
  ...
  const handleFormSubmit = async (e) => {
    ...
    await dispatch(
      updateBarangayOfficial({ id: barangayofficials._id, barangayData: data })
    );
    setFormData("");
  ...
  return (
    <>
      <button
        className="w-full flex gap-1 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white  "
      ...
      <Modal
        ...
        size={"6xl"}
      >
        <Modal.Header>Update Barangay Official</Modal.Header>
